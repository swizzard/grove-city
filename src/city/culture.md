...
* plains folk tradition
    ...
    * age-mates
        * discrete groups by birth-year
        * support groups(/dedicated spaces?) of/for pregnant/nursing people
        * no formal school but understanding that children should be raised together
        * neighbors && classmates && parents' friends' kids 
        * inter-year competition encouraged
        * most important for children but semi-ironic "oh a $PERSON-BORN-IN-YEAR would say that" kind of joking
        * some parents-of affiliation as well
* sunnyside somewhat self-reliant w/r/t sewage, fires, sanitation
    * fire fighting squads
    * beautification clubs
    * packs of bored guys who show up at your store every few months and demand to "measure your floor"
    * anti-littering ruffians
    * childrearing groups
        * (semi-?)professionalized?
    * professional associations
    * your block has a color/pattern/chant/etc
...
* 1 batter, 1 pitcher + 5 fielders
* bat broad and flat, vaguely hand-shaped
    * maybe strapped to hand?
    * [basque pelota chistera](https://en.wikipedia.org/wiki/Basque_pelota#The_gloves_(chistera))
* batter has to hit ball past fielders & run around bases
    * 1 point per base
