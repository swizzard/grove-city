...
* employment
    ...
    * haggling
* overland trade with plains/hills
    * not formalized/institutionalized
    * small-scale traders
    * risky, expensive
...
* business loans
* "rent"
    * land and buildings financed separately
    * offices/factories/warehouses financed with bf resources are business assets, not assessed separately
        * possibility of losing home as well as business somewhat discourages hf tradition of living at work
    * slight majority of residential housing built 
        * net result is a twice-yearly tithing ritual parade carrying offerings from Low Quarter past Memory Park in Underbrush to the Grove
        * clockwise 
        * traditional offerings + some showing off
        * state fair vibes
        * occasionally slightly hostile
